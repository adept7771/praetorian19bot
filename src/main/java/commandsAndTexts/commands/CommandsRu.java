...
public enum CommandsRu {
    ...
    defaultlanguageadm("Язык бота для всех пользователей по умолчанию. Админская настройка. Пример: /defaultlanguageadmen /defaultlanguageadmru. Поддерживаемые языки: En, Ru"),
