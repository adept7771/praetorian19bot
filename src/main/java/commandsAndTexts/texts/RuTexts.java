...
public enum RuTexts {
    ...
    defaultGreetings(" Привет! Антиспам защита. Пожалуйста, ответьте на это сообщение. Любые другие ваши сообщения будут расценены как спам. Ответ принимается в форме числа. Сколько будет: "),
